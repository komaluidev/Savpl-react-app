...
const Step2 = () => {
  ...
  const pageInstruction = "Treat the seeds using approved bio-fertilizers or protection agents before sowing. This enhances germination and protects against soil-borne diseases.";
